...
let personName = "Maira";
let message1 = `"Hello ${personName}, would you like some tea?"`;
console.log(message1);
// question no 3
//  Name Cases: Store a person’s name in a variable, and then print that person’s name in lowercase, uppercase, and titlecase.
let name = "Maira Abbas";
// lowercase
...
let authorname = ("Benjamin Franklin once said,");
const quote = `${authorname}"welldone is better than well said."`;
console.log(quote);
// question no 5
...
let famous_person = ("Tony Robbins once said,");
const message = `${famous_person}"The only impossible journey is the one you never begin."`;
console.log(message);
// question no 6
