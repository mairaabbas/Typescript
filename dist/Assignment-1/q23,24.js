...
console.log("count >= 10 should be true => ", count >= 10);
console.log("count <= 10 should be true => ", count <= 10);
console.log("count > 6 && count == 10 should be true => ", count > 6 && count == 10);
console.log("count < 6 && count > 10 should be false => ", count > 6 && count > 10);
console.log("count < 6 || count > 10 should be false => ", count < 6 || count > 10);
console.log("count > 6 || count == 10 should be true => ", count > 6 || count == 10);
...
console.log("arr.includes('items', 1) should be false =>", array.includes("items", 1));
